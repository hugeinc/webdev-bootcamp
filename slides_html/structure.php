...
<div class="slide">
    ...
    <ul class="build">
        <li>Create a new Folder (on your desktop, in your documents, etc.) that will contain your project. Call it <strong>holdens_web</strong></li>
        <li>Copy the folder called <strong>css</strong> located on the usb drive into your holdens_web folder</li>
        <li>Copy the folder called <strong>images</strong> located on your usb drive into your holdens_web folder</li>
